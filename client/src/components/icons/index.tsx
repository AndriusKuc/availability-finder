...
export function Lock({ size = 48, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CheckCircle({ size = 64, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CalendarDays({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Link({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UserX({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
